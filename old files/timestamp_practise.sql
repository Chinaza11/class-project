...
insert into treatments (treatments_name,year,replicate,root_knot_nematode_planting,root_knot_nematode_midseason,root_knot_nematode_end_of_season,weed,vigor_rating,gall_rating,fruit_yield,southern_blight,latitude,longitude, timestamp) values ('Untreated check',2019,1,7,1,320,9,4,3,51,8,31.502951,-83.545263,datetime('now', 'localtime'));
